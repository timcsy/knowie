...
const messages = {
  en: {
    ...
    'cli.init.domainSkills': (n, d) => `  ✓ Installed ${n} learned domain skill(s) to ${d} tool location(s)`,
    'cli.init.done': '✅ Done!',
    ...
    'cli.update.domainSkills': (n, d) => `  ✓ Synced ${n} learned domain skill(s) to ${d} tool location(s)`,
  ...
  'zh-TW': {
    ...
    'cli.init.domainSkills': (n, d) => `  ✓ 已安裝 ${n} 個學到的 domain skill 到 ${d} 個工具位置`,
    'cli.init.done': '✅ 完成！',
