...
The human-initiated **OUT** of the dispatch pipe: take a *ripe* `draft/` topic and consolidate it into the long-term tier. (capture is the IN — new thinking → draft; crystallize is the OUT — mature draft → concept / principle / experience / roadmap / history.)
...
## Invariants
- **Captured ≠ committed** — crystallize only what the human confirms is settled.
