...
兩個後果：
- **過時 skill 比過時知識更危險**：知識被讀（誤導），skill 被執行（會 acts、可能靜默作惡）→ 見 [收斂](發散的自我維護是在自動製造熵.md) 失敗模式。
...
## 相關
[協議非平台](協議非平台.md)、[收斂](發散的自我維護是在自動製造熵.md)、[意義可追溯改寫](意義可追溯改寫.md)（why 的另一性質：不只無 oracle，還會被未來改寫）
