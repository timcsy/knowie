...
**拿去真實專案測**（里程碑，分兩階）— dogfood 驗得了結構與機制，驗不了 domain 層。但 **固化 ≠ 外推**：工具自身還沒穩（churn 未收斂）前外推會散播不穩定，所以**先內省、後外推**。設計脈絡 ←→ [記憶動態](draft/2026-06-06-記憶動態.md)、[怎麼知道knowie好不好](draft/2026-06-05-怎麼知道knowie好不好.md)。
- **階段一（現在）·經驗者內省自評**：
