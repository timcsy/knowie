...
> 這是 [knowie](https://github.com/timcsy/knowie) **自己的**知識庫——knowie 用自己維護自己（dogfood）。knowie 是一個讓 AI 結構化地維護專案知識的工具；不熟它也沒關係，下面就能讀懂。

## 從這三個檔開始
- **`principles.md`** — 原則：knowie 不可妥協的核心信念與規則（分「根本原則」和從它推導的「延伸原則」）。
